...
<section class="my-5 py-5">
    ...
    <div class="mx-auto container">
        <form id="checkout-form">
            ...
            <div class="form-group">
                <label>Email</label>
                <input type="password" class="form-control" id="checkout-email" name="name" placeholder="Email" required>
            </div>
            <div class="form-group checkout-small-element">
                <label>Phone</label>
                <input type="tel" class="form-control" id="checkout-tel" name="phone" placeholder="Phone" required>
            </div>
            ...
            <div class="form-group">
                <input type="submit" class="btn" id="checkout-btn" value="Register"/>
                </div>
