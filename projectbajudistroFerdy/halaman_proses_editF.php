  ...
  if($gambar_game != "") {
    ...
    if(in_array($ekstensi, $ekstensi_diperbolehkan) === true)  {
                  move_uploaded_file($file_tmp, 'asets/imgs/'.$nama_gambar_baru); //memindah file gambar ke folder gambar
                   ...
                   $query  = "UPDATE bajudistro SET nama_baju = '$nama_game', deskripsi = '$deskripsi', kategori = '$kategori', harga = '$harga', gambar_baju = '$nama_gambar_baru'";
                    $query .= "WHERE id = '$id'";
                    ...
                    if(!$result){
                      ...
                      echo "<script>alert('Data berhasil diubah.');window.location='halaman_crudF.php';</script>";
                    }
              } else {     
      ...
      // jalankan query UPDATE berdasarkan ID yang produknya kita edit
      $query  = "UPDATE bajudistro SET nama_baju = '$nama_baju', deskripsi = '$deskripsi', kategori = '$kategori', harga = '$harga'";
      $query .= "WHERE id = '$id'";
      $result = mysqli_query($koneksi, $query);
      // periska query apakah ada error
      if(!$result){
